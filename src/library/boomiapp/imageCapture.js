    ...
    nav.querySelector('.bph-capture-process').addEventListener('click', event => {
        ...
        <div class="alert_label_content information_label_content" style="max-height: 600px; max-width: 600px; overflow: auto; padding: 10px; border-radius: 4px; box-shadow: 0 0 20px 0 rgba(0,0,0,0.25); background-color: #ffffff;">
            ...
            <div class="alert_text">
                <p><b>Boomi Platform Enhancer:</b> Capture the Full Process Flow to Image</p>
                ...
                <div>
                    ...
                    <select class="uiscale" style="padding-left: 10px; margin-left: 10px;">
                ...
                <div style="margin-top: 10px; padding-top: 10px;">
                    <button type="button" class="gwt-Button action_button" title="Run Capture Process">Capture Process Flow Now</button>
                    <button type="button" class="gwt-Button" data-locator="link-cancel" style="float: right;" onclick="javascript:document.querySelector('.BoomiPlatformOverlay').remove();">Cancel Capture</button>
                </div>
            </div>
        </div>
    </div>`;
