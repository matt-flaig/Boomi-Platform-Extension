document.arrive(".filter_panel_dialog_popup_panel", function (filterpanel) {
    if(filterpanel.querySelector(".filterable_tree_loading_container")){
        ...
        buttonBar[0].insertAdjacentHTML('beforeend', '<button type="button" id="coladepButton" class="gwt-Button drop_button" style="position: absolute">Collapse All Folders</button>')
    }
});
