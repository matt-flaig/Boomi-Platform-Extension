document.arrive(".connectorActionConfig", function () {
  ...
  if (httpRemind) {
    actionLable[0].innerHTML =
      actionLable[0].innerHTML +
      '<br> <b style="color: orange" class="boomiHTTPReminder">Reminder:</b> Incoming message shapes will not work into the HTTP connector if you have set connector parameters!';
  } else {
    letsCheck();
  }
});
