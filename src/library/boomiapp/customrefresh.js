...
const refreshInterval_listener = (refreshInterval) => {
    ...
    $('.reporting_right_side').prepend($('<li id="refresh_reporting"> <button  type="button" class="refresh_primary_action" alt="off">Refresh Every '+ BoomiPlatform.refresh_interval +'s</button> </li>'));
