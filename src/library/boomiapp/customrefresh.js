...
const refreshInterval_listener = (refreshInterval) => {
    ...
    $('.reporting_right_side').prepend($('<li id="refresh_reporting"> <button  type="button" class="qm-button--primary-action" alt="off">Start Refresh</button> </li>'));
    ...
    window.onhashchange = function regresh() {
        ...
        if (vali == true) {
            ...
            var child = document.getElementById("refresh_reporting") //.remove;
